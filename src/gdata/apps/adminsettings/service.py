...
class AdminSettingsService(gdata.apps.service.PropertyService):
    ...
    # noinspection PyComparisonWithNone,PyComparisonWithNone,PyComparisonWithNone,PyComparisonWithNone,PyComparisonWithNone,PyComparisonWithNone,PyComparisonWithNone,PyComparisonWithNone,PyComparisonWithNone,PyComparisonWithNone
    ...
    def AddEmailRoute(self, routeDestination, routeRewriteTo, routeEnabled, bounceNotifications, accountHandling):
        ...
        properties = {'routeDestination': routeDestination, 'routeRewriteTo': gdata.apps.service._bool2str(routeRewriteTo),
                      'routeEnabled': gdata.apps.service._bool2str(routeEnabled), 'bounceNotifications': gdata.apps.service._bool2str(bounceNotifications),

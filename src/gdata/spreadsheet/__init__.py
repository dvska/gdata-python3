...
def SpreadsheetsListFromString(xml_string):
    return atom.CreateClassFromXMLString(SpreadsheetsList, xml_string)
    # element_tree = ElementTree.fromstring(xml_string)
...
class SpreadsheetsSpreadsheetsFeed(gdata.GDataFeed):
    ...
    _children['{%s}entry' % atom.ATOM_NAMESPACE] = ('entry', [SpreadsheetsSpreadsheet])


def SpreadsheetsSpreadsheetsFeedFromString(xml_string):
    return atom.CreateClassFromXMLString(SpreadsheetsSpreadsheetsFeed, xml_string)
...
class SpreadsheetsWorksheetsFeed(gdata.GDataFeed):
    ...
    _children = gdata.GDataFeed._children.copy()
    _attributes = gdata.GDataFeed._attributes.copy()
    _children['{%s}entry' % atom.ATOM_NAMESPACE] = ('entry', [SpreadsheetsWorksheet])


def SpreadsheetsWorksheetsFeedFromString(xml_string):
    return atom.CreateClassFromXMLString(SpreadsheetsWorksheetsFeed, xml_string)
...
class SpreadsheetsCellsFeed(gdata.BatchFeed):
    ...
    _children['{%s}entry' % atom.ATOM_NAMESPACE] = ('entry', [SpreadsheetsCell])
    _children['{%s}rowCount' % GSPREADSHEETS_NAMESPACE] = ('row_count', RowCount)
    _children['{%s}colCount' % GSPREADSHEETS_NAMESPACE] = ('col_count', ColCount)
...
def SpreadsheetsCellsFeedFromString(xml_string):
    return atom.CreateClassFromXMLString(SpreadsheetsCellsFeed, xml_string)
...
class SpreadsheetsListFeed(gdata.GDataFeed):
    ...
    _children = gdata.GDataFeed._children.copy()
    _attributes = gdata.GDataFeed._attributes.copy()
    _children['{%s}entry' % atom.ATOM_NAMESPACE] = ('entry', [SpreadsheetsList])


def SpreadsheetsListFeedFromString(xml_string):
    return atom.CreateClassFromXMLString(SpreadsheetsListFeed, xml_string)

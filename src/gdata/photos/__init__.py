...
class AlbumData(object):
    _children = {'{%s}id' % PHOTOS_NAMESPACE: ('gphoto_id', Id), '{%s}name' % PHOTOS_NAMESPACE: ('name', Name),
                 '{%s}location' % PHOTOS_NAMESPACE: ('location', Location), '{%s}access' % PHOTOS_NAMESPACE: ('access', Access),
                 '{%s}bytesUsed' % PHOTOS_NAMESPACE: ('bytesUsed', BytesUsed), '{%s}timestamp' % PHOTOS_NAMESPACE: ('timestamp', Timestamp),
                 '{%s}numphotos' % PHOTOS_NAMESPACE: ('numphotos', Numphotos),
                 '{%s}numphotosremaining' % PHOTOS_NAMESPACE: ('numphotosremaining', Numphotosremaining), '{%s}user' % PHOTOS_NAMESPACE: ('user', User),
                 '{%s}nickname' % PHOTOS_NAMESPACE: ('nickname', Nickname),
                 '{%s}commentingEnabled' % PHOTOS_NAMESPACE: ('commentingEnabled', CommentingEnabled),
                 '{%s}commentCount' % PHOTOS_NAMESPACE: ('commentCount', CommentCount)}
...
class CommentData(GPhotosBaseData):
    _children = {'{%s}id' % PHOTOS_NAMESPACE: ('gphoto_id', Id), '{%s}albumid' % PHOTOS_NAMESPACE: ('albumid', Albumid),
                 '{%s}photoid' % PHOTOS_NAMESPACE: ('photoid', Photoid), '{%s}author' % atom.ATOM_NAMESPACE: ('author', [CommentAuthor, ])}
    ## NOTE: storing photo:id as self.gphoto_id, to avoid name clash with atom:id
    gphoto_id = None
    albumid = None
    photoid = None
...
class UserData(GPhotosBaseData):
    _children = {'{%s}maxPhotosPerAlbum' % PHOTOS_NAMESPACE: ('maxPhotosPerAlbum', MaxPhotosPerAlbum),
                 '{%s}nickname' % PHOTOS_NAMESPACE: ('nickname', Nickname), '{%s}quotalimit' % PHOTOS_NAMESPACE: ('quotalimit', Quotalimit),
                 '{%s}quotacurrent' % PHOTOS_NAMESPACE: ('quotacurrent', Quotacurrent), '{%s}thumbnail' % PHOTOS_NAMESPACE: ('thumbnail', Thumbnail),
                 '{%s}user' % PHOTOS_NAMESPACE: ('user', User), '{%s}id' % PHOTOS_NAMESPACE: ('gphoto_id', Id)}

...
class DocsClient(gdata.client.GDClient):
    ...
    @staticmethod
    def _get_download_uri(base_uri, extra_params=None):
    ...
    @staticmethod
    def _check_entry_is_resource(entry):
    ...
    @staticmethod
    def _check_entry_has_content(entry):
    ...
    def publish_revision(self, entry, publish_auto=None,
        ...
        elif not publish_outside_domain:
            entry.publish_outside_domain = \
